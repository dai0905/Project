...
('SP012', 'iPhone 14', 'TH001', 'iOS 17', '12 MP', '2 camera 12 MP', N'6.1" - Tần số quét 60 Hz', 'BN001', 'RAM001', 'Apple A15 Bionic', '3349 mAh', N'Khung nhôm & Mặt lưng kính cường lực', 'Dài 146.7 mm - Ngang 71.5 mm - Dày 7.8 mm - Nặng 172 g', '09/2022', 'MAU005', 100, 15590000, 17090000, N'iPhone 14 (ra mắt năm 2022) là dòng điện thoại thông minh của Apple với nhiều cải tiến về hiệu năng và tính năng so với thế hệ trước. Nó có màn hình OLED Super Retina XDR, chip A15 Bionic (vẫn rất mạnh mẽ) cho phiên bản tiêu chuẩn và A16 Bionic cho iPhone 14 Pro. Camera chính 12MP trên phiên bản thường và 48MP trên mẫu Pro mang lại chất lượng ảnh sắc nét, cùng với các tính năng như chế độ Cinematic và Photonic Engine. Ngoài ra, iPhone 14 còn hỗ trợ kết nối 5G, tính năng phát hiện va chạm (Crash Detection), và thời lượng pin dài hơn so với các phiên bản trước.', 'iphone14_timnhat.jpg', 'iphone14_thongso.jpg'),
...
--Thêm tài khoản
INSERT INTO TaiKhoan (MaTaiKhoan, MatKhau, Ten, SDT, Email, DiaChi, MaQuyen) VALUES
('chien123','123456',N'Hoàng Hữu Chiến','0923872167', N'chien@gmail.com', N'Hà Nội',2),
('admin123','admin123456',N'Admin','0923872168', N'admin@gmail.com',N'Hà Nội',1),
('dai123','123456',N'Hoàng Văn Đại','0923872162', N'thoiloan2030@gmail.com',N'Hà Nội',2);

INSERT INTO HD_BanHang (MaHD, MaTaiKhoan, Ten, SDT, DiaChi, PTThanhToan, NgayBan, TongTien, MaTrangThai) VALUES
('HD001', 'chien123', N'Hoàng Hữu Chiến','0923872167',N'Hà Nội', N'Thanh toán khi nhận hàng (COD)', '2024-10-01', 0, 'TT003'),  -- Tổng tiền sẽ được tính lại từ CT_HD_BanHang
('HD002', 'chien123', N'Hoàng Hữu Chiến','0923872167',N'Hà Nội', N'Thanh toán khi nhận hàng (COD)', '2024-10-02', 0, 'TT003'),
('HD003', 'dai123',N'Hoàng Văn Đại','0923872162',N'Hà Nội', N'Thanh toán khi nhận hàng (COD)', '2024-10-03', 0, 'TT002'),
('HD004', 'dai123',N'Hoàng Văn Đại','0923872162',N'Hà Nội', N'Thanh toán khi nhận hàng (COD)', '2024-10-04', 0, 'TT001'),
('HD005', 'chien123', N'Hoàng Hữu Chiến','0923872167',N'Hà Nội', N'Thanh toán khi nhận hàng (COD)', '2024-10-05', 0, 'TT002'),
('HD006', 'dai123',N'Hoàng Văn Đại','0923872162',N'Hà Nội', N'Thanh toán khi nhận hàng (COD)', '2024-10-06', 0, 'TT001');
